...
sed -i "9 i\      3 => 'oc3.docker'," /var/www/html/config/config.php
...
sed -i "8 i\    'mode'              => 'userid'," /var/www/html/config/config.php
sed -i "9 i\    'search-attribute'  => 'email'," /var/www/html/config/config.php
sed -i "10 i\    'insecure'          => true," /var/www/html/config/config.php
sed -i "11 i\  ]," /var/www/html/config/config.php
