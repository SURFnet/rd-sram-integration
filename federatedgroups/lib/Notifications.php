...
class Notifications {
	 ...
	 * @throws \Exception
	 */
	protected function sendOcmRemoteShare(Address $shareWithAddress, Address $ownerAddress, Address $sharedByAddress, $token, $name, $remote_id, $remoteShareType = 6) {
		$shareType = ($remoteShareType === 6 ? "user" : "group");
		error_log("sendOcmRemoteShare $shareType");
		$fields = [
