...
use OCA\Files_Sharing\AppInfo\Application as FilesSharingApplication;
use OCA\OpenCloudMesh\AppInfo\Application as OCMApplication;
...
abstract class TestCase extends \Test\TestCase {
	...
	public static function setUpBeforeClass(): void {
		...
		if (!self::$alreadyRegistered) {
			$application = new OCMApplication();
			$application->registerMountProviders();
			$application = new FilesSharingApplication();
