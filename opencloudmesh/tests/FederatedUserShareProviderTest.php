...
/**
 * Class FederatedUserShareProviderTest
 *
 * @package OCA\OpenCloudMesh\Tests
 * @group DB
 */
class FederatedUserShareProviderTest extends \Test\TestCase {
	...
	/** @var UserNotifications | MockObject */
	...
	public function setUp(): void {
		...
		$this->eventDispatcher = $this->getMockBuilder(EventDispatcherInterface::class)
			...
			->getMock();
		$this->notifications = $this->createMock(UserNotifications::class);
		...
		$this->provider = new FederatedUserShareProvider(
			$this->connection,
	...
	public function testUpdate($owner, $sharedBy, $isOwnerLocal, $isSharerLocal, $shouldUpdate) {
		$this->provider = $this->getMockBuilder(FederatedUserShareProvider::class)
			->setConstructorArgs(
				[
					$this->connection,
