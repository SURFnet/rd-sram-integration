...
class GroupNotificationsTest extends \Test\TestCase {
	 ...
	 * @return GroupNotifications | \PHPUnit\Framework\MockObject\MockObject
	 */
	private function getInstance(array $mockedMethods = []) {
		if (empty($mockedMethods)) {
			$instance = new GroupNotifications(
				$this->addressHandler,
			...
			$instance = $this->getMockBuilder(GroupNotifications::class)
				->setConstructorArgs(
					[
						$this->addressHandler,
						$this->httpClientService,
